...
def mul_name(speed):
    ...
    while run_mul_name:
        ...
        show_txt('You have to make it till the end. Best of luck!!',
                 255, 64, 64, 40, 70, 430)
    ...
    while run_w_l == True:
        ...
        if a_i == True:  # DECLARING THE WINNER
            ...
            if high_score_ai_free < p_s:
                show_txt('Congrats...you have beaten your highest score',
                         255, 255, 255, 40, 80, 40)
                show_txt('Highest score: '+str(l1),
                         255, 255, 255, 40, 330, 120)
            ...
            show_txt('Congratulations' if l1 > l2 or l2 >
                     l1 else '', 255, 255, 255, 80, 210.5, 40)
            if l1 < l2:
